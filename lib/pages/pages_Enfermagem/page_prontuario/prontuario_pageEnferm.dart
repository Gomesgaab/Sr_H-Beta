...
import 'package:flutter_srh_application/service/Prontuario_Detail/prontuario_detail%20Enfermeiro.dart';
import 'package:flutter_srh_application/shared/form_prontuario/form_prntuario.dart';

class PageProntuarioEnferm extends StatefulWidget {
  const PageProntuarioEnferm({super.key});

  @override
  State<PageProntuarioEnferm> createState() => _PageProntuarioEnfermState();
}

class _PageProntuarioEnfermState extends State<PageProntuarioEnferm> {
  //chamando instanci do firebase firestore
    ...
    return Scaffold(
      body: Container(
        ...
        child: StreamBuilder<QuerySnapshot>(
          //definindo caminho para visualização de dados
            stream: db
      ...
      //botão de criação de prontuario
