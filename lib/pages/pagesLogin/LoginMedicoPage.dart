...
class ConfirmarMedico extends StatefulWidget {
  const ConfirmarMedico({super.key});

  @override
  State<ConfirmarMedico> createState() => _ConfirmarMedicoState();
}

class _ConfirmarMedicoState extends State<ConfirmarMedico> {
                                ...
                                child: TextFormField(
                                  ...
                                  validator: (String? value) {
                                    ...
                                    if (value.contains("enferm") ||
                                        value.contains("recepcionista")) {
                                      return "O e-email informado não e dessa área de login";
                                    }
                                    return null;
                                  },
                                ),
  ...
  botaoPrincipalClicado() {
    if (_formKey.currentState!.validate()) {
      if (queroEntrar) {
        ...
        _autenMedico.logarUsuario(
            email: emailControler.text, senha: senhaControler.text).then((String? erro){
              if(erro != null){
